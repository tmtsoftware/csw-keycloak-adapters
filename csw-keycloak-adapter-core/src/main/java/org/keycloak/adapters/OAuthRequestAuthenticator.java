...
public class OAuthRequestAuthenticator {
    ...
    protected String stripOauthParametersFromRedirect() {
        KeycloakUriBuilder builder = KeycloakUriBuilder.fromUri(facade.getRequest().getURI())
                .replaceQueryParam(OAuth2Constants.CODE, (Object) null)
                .replaceQueryParam(OAuth2Constants.STATE, (Object) null)
                .replaceQueryParam(OAuth2Constants.SESSION_STATE, (Object) null)
                .replaceQueryParam(OAuth2Constants.ISSUER, (Object) null);
